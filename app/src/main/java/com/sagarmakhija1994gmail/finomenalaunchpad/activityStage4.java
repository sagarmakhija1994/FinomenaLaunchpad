...
public class activityStage4 extends AppCompatActivity {
    SQLiteDatabase db;
    String strText = "4";
    String aa = "4";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activity_stage4);
    ...
    public void button41 (View v)
    {
        ...
        Intent i = new Intent(context,activityStage4_1.class);
        startActivity(i);
        finish();
    }
    ...
    {
        final Context context = this;
        Intent i = new Intent(context,activityStage4_2.class);
        startActivity(i);
        finish();
    }
    ...
    {
        final Context context = this;
        Intent i = new Intent(context,activityStage4_3.class);
        startActivity(i);
        finish();
    }
    ...
    {
        final Context context = this;
        Intent i = new Intent(context,activityStage4_4.class);
        startActivity(i);
        finish();
    }
