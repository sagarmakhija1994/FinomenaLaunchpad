...
public class activityStage6 extends AppCompatActivity {
    String strText = "4";
    String aa = "4";
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activity_stage6);
    ...
    public void button61 (View v)
    {
        ...
        Intent i = new Intent(context,activityStage6_1.class);
        startActivity(i);
        finish();
    }
    ...
    {
        final Context context = this;
        Intent i = new Intent(context,activityStage6_2.class);
        startActivity(i);
        finish();
    }
    ...
    {
        final Context context = this;
        Intent i = new Intent(context,activityStage6_3.class);
        startActivity(i);
        finish();
    }
    ...
    {
        final Context context = this;
        Intent i = new Intent(context,activityStage6_4.class);
        startActivity(i);
        finish();
    }
    ...
    {
        final Context context = this;
        Intent i = new Intent(context,activityStage6_5.class);
        startActivity(i);
        finish();
    }
    ...
    {
        final Context context = this;
        Intent i = new Intent(context,activityStage6_6.class);
        startActivity(i);
        finish();
    }
