...
public class activityStage4_1 extends AppCompatActivity {
    String strText = "4";
    SQLiteDatabase db;
    String aa = "4";
    int val;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activity_stage4_1);
    ...
    public void randm4()
    {
        ...
        timer.cancel();
        timer.start();
        Button btn1x = (Button) findViewById(R.id.button4_1_1);
        Button btn2x = (Button) findViewById(R.id.button4_1_2);
        Button btn3x = (Button) findViewById(R.id.button4_1_3);
        Button btn4x = (Button) findViewById(R.id.button4_1_4);
