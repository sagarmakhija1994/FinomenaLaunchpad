...
public class activityStage10 extends AppCompatActivity {
    SQLiteDatabase db;
    String strText = "4";
    String aa = "4";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activity_stage10);
    ...
    public void button101 (View v)
    {
        ...
        Intent i = new Intent(context,activityStage10_1.class);
        startActivity(i);
        finish();
    }
    ...
    {
        final Context context = this;
        Intent i = new Intent(context,activityStage10_2.class);
        startActivity(i);
        finish();
    }
    ...
    {
        final Context context = this;
        Intent i = new Intent(context,activityStage10_3.class);
        startActivity(i);
        finish();
    }
    ...
    public void button104 (View v)
    {
        final Context context = this;
        Intent i = new Intent(context,activityStage10_4.class);
        startActivity(i);
        finish();
    }
    public void button105 (View v)
    {
        final Context context = this;
        Intent i = new Intent(context,activityStage10_5.class);
        startActivity(i);
        finish();
    ...
    public void button106 (View v)
    {
        final Context context = this;
        Intent i = new Intent(context,activityStage10_6.class);
        startActivity(i);
        finish();
    }
