...
public class activityStage6_1 extends AppCompatActivity {
    String strText = "4";
    String aa = "4";
    SQLiteDatabase db;
    int val;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activity_stage6_1);
    ...
    public void randm4()
    {
        ...
        int[] ex = new int[]{a1,a2,a3,a4,a5,a6};
        try{
            val = getRandomWithExclusion(r, 0, 6, ex);
        }
        ...
        if(a1==1 && a2==2 &a3==3 && a4==4 && a5==5 && a6==6 && val ==0)
        {
            timer.cancel();
    ...
    public void timer4()
    {
        timer = new CountDownTimer(500000,100) {
            ...
            public void onTick(long millisUntilFinished) {
                if(btn1Down == 2 ||btn3Down == 2 || btn5Down == 2 || btn1Down == 3 || btn3Down == 3 ||btn5Down == 3)
                {
                    timer.cancel();
                    alartTitle="Information";
                ...
                if(btn2Down == 2 ||btn4Down == 2 || btn6Down == 2 ||btn2Down == 3 || btn4Down == 3 ||btn6Down == 3)
                {
                    timer.cancel();
                    alartTitle="Information";
