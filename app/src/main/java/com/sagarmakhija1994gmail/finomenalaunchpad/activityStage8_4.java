...
public class activityStage8_4 extends AppCompatActivity {
    SQLiteDatabase db;
    String strText = "4";
    String aa = "4"; int val;
    Random r = new Random();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activity_stage8_4);
    ...
    public void randm4()
    {
        ...
        timer.cancel();
        timer.start();
        Button btn1x = (Button) findViewById(R.id.button8_1_1);
        Button btn2x = (Button) findViewById(R.id.button8_1_2);
        Button btn3x = (Button) findViewById(R.id.button8_1_3);
        Button btn4x = (Button) findViewById(R.id.button8_1_4);
        Button btn5x = (Button) findViewById(R.id.button8_1_5);
        Button btn6x = (Button) findViewById(R.id.button8_1_6);
        Button btn7x = (Button) findViewById(R.id.button8_1_7);
        Button btn8x = (Button) findViewById(R.id.button8_1_8);
        int[] ex = new int[]{a1,a2,a3,a4,a5,a6,a7,a8};
        try{
            val = getRandomWithExclusion(r, 0, 8, ex);
        }
        ...
        if(a1==1 && a2==2 &a3==3 && a4==4 && a5==5 && a6==6 && a7==7 && a8==8 && val ==0)
        {
            timer.cancel();
    ...
    public void timer4()
    {
        timer = new CountDownTimer(500000,100) {
            ...
            public void onTick(long millisUntilFinished) {
                if(btn1Down == 2 ||btn3Down == 2 || btn5Down == 2 || btn7Down == 2 ||  btn1Down == 3 || btn3Down == 3 || btn5Down == 3 || btn7Down == 3 )
                {
                    timer.cancel();
                    alartTitle="Information";
                ...
                if(btn2Down == 2 ||btn4Down == 2 || btn6Down == 2 ||  btn8Down == 2 ||btn2Down == 3 || btn4Down == 3 || btn6Down == 3 ||  btn8Down == 3 )
                {
                    timer.cancel();
                    alartTitle="Information";
